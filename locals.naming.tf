...
locals {
  ...
  vmss_name     = coalesce(var.custom_vmss_name, data.popsrox_resource_name.vmss_linux.result)
  nic_name      = coalesce(var.custom_nic_name, data.popsrox_resource_name.nic.result)
  ipconfig_name = coalesce(var.custom_ipconfig_name, data.popsrox_resource_name.ipconfig.result)
